...
@Component
public class SupportCommandHandler implements CommandHandler<SendMessage> {

    private final BotConfig botConfig;

    public SupportCommandHandler(BotConfig botConfig) {
    ...
    public CommandActions handle(Update update) {
        ...
        SendMessage sm = new SendMessage(chatId, botConfig.getMessages().getSupport());
